...
@RunWith(RobolectricTestRunner.class) public class WikiSiteTest {
    ...
    @Test public void testUnmarshal() {
        ...
        MatcherAssert.assertThat(GsonUnmarshaller.unmarshal(WikiSite.class, GsonMarshaller.marshal(wiki)), is(wiki));
    }
    ...
    @Test public void testTitleForInternalLink() {
        ...
        MatcherAssert.assertThat(new PageTitle("Main Page", wiki), Matchers.is(wiki.titleForInternalLink("")));
        MatcherAssert.assertThat(new PageTitle("Main Page", wiki), Matchers.is(wiki.titleForInternalLink("/wiki/")));
        MatcherAssert.assertThat(new PageTitle("wiki", wiki), Matchers.is(wiki.titleForInternalLink("wiki")));
        MatcherAssert.assertThat(new PageTitle("wiki", wiki), Matchers.is(wiki.titleForInternalLink("/wiki/wiki")));
        MatcherAssert.assertThat(new PageTitle("wiki/wiki", wiki), Matchers.is(wiki.titleForInternalLink("/wiki/wiki/wiki")));
    }
