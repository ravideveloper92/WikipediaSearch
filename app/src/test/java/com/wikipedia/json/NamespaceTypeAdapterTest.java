...
@RunWith(ParameterizedRobolectricTestRunner.class) public class NamespaceTypeAdapterTest {
    ...
    @Test public void testWriteRead() {
        Namespace result = GsonUnmarshaller.unmarshal(Namespace.class, GsonMarshaller.marshal(namespace));
    ...
    @Test public void testReadOldData() {
        ...
        Namespace ns = GsonUnmarshaller.unmarshal(Namespace.class, marshaledStr);
