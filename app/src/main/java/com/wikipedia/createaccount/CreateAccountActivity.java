...
import com.wikipedia.analytics.CreateAccountFunnel;
...
import com.wikipedia.dataclient.mwapi.ListUserResponse;
...
import com.wikipedia.views.NonEmptyValidator;
    ...
    public void handleAccountCreationError(@NonNull String message) {
        if (message.contains("blocked")) {
            FeedbackUtil.makeSnackbar(this, getString(R.string.create_account_ip_block_message), FeedbackUtil.LENGTH_DEFAULT)
                    .setAction(R.string.create_account_ip_block_details, v -> UriUtil.visitInExternalBrowser(CreateAccountActivity.this,
