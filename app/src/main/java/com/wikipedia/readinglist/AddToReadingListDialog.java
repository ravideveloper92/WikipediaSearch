...
public class AddToReadingListDialog extends ExtendedBottomSheetDialogFragment {
    ...
    public static AddToReadingListDialog newInstance(@NonNull PageTitle title, Constants.InvokeSource source) {
    ...
    public static AddToReadingListDialog newInstance(@NonNull List<PageTitle> titles, Constants.InvokeSource source) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeSource = (Constants.InvokeSource) getArguments().getSerializable(Constants.INTENT_EXTRA_INVOKE_SOURCE);
