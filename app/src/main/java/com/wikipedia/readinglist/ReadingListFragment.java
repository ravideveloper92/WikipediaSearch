...
import com.wikipedia.events.PageDownloadEvent;
...
import com.wikipedia.views.MultiSelectActionModeCallback;
import com.wikipedia.views.PageItemView;
import com.wikipedia.views.SearchEmptyView;
import com.wikipedia.views.SwipeableItemTouchHelperCallback;
...
import static com.wikipedia.readinglist.ReadingListActivity.EXTRA_READING_LIST_ID;
import static com.wikipedia.readinglist.ReadingListsFragment.ARTICLE_ITEM_IMAGE_DIMENSION;
    ...
    private void addSelectedPagesToList() {
        ...
        if (!selectedPages.isEmpty()) {
            ...
            bottomSheetPresenter.show(getChildFragmentManager(),
                    AddToReadingListDialog.newInstance(titles, Constants.InvokeSource.READING_LIST_ACTIVITY));
            update();
        }
    }
