...
import com.wikipedia.main.MainFragment;
...
import com.wikipedia.readinglist.sync.ReadingListSyncEvent;
...
import com.wikipedia.WikipediaApp;
import com.wikipedia.analytics.ReadingListsFunnel;
import com.wikipedia.auth.AccountUtil;
import com.wikipedia.events.ArticleSavedOrDeletedEvent;
import com.wikipedia.feed.FeedFragment;
import com.wikipedia.history.HistoryEntry;
import com.wikipedia.history.SearchActionModeCallback;
import com.wikipedia.main.MainActivity;
import com.wikipedia.main.MainFragment;
import com.wikipedia.onboarding.OnboardingView;
import com.wikipedia.page.ExclusiveBottomSheetPresenter;
import com.wikipedia.page.PageActivity;
import com.wikipedia.page.PageAvailableOfflineHandler;
import com.wikipedia.page.PageTitle;
...
import com.wikipedia.views.PageItemView;
import com.wikipedia.views.ReadingListsOverflowView;
import com.wikipedia.views.SearchEmptyView;
...
import static com.wikipedia.Constants.InvokeSource.READING_LIST_ACTIVITY;
import static com.wikipedia.readinglist.database.ReadingList.SORT_BY_NAME_ASC;
import static com.wikipedia.readinglist.database.ReadingList.SORT_BY_NAME_DESC;
import static com.wikipedia.readinglist.database.ReadingList.SORT_BY_RECENT_ASC;
import static com.wikipedia.readinglist.database.ReadingList.SORT_BY_RECENT_DESC;
import static com.wikipedia.util.ResourceUtil.getThemedAttributeId;
import static com.wikipedia.views.CircularProgressBar.MAX_PROGRESS;
...
public class ReadingListsFragment extends Fragment implements
    ...
    public void onAddItemToOther(@NonNull ReadingListPage page) {
        bottomSheetPresenter.show(getChildFragmentManager(),
                AddToReadingListDialog.newInstance(ReadingListPage.toPageTitle(page), Constants.InvokeSource.READING_LIST_ACTIVITY));
    }
