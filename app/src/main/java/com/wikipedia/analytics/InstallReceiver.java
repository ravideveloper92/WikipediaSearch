    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        switch (action) {
            case INSTALL_ACTION:
                ...
                //     `adb shell am broadcast -a com.android.vending.INSTALL_REFERRER -n com.wikipedia.dev/com.wikipedia.analytics.InstallReceiver --es "referrer" "referrer_url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FWombat&campaign_id=foo&install_id=bar"`
                // * invoke the receiver but don't open the app (bad url):
                //     `adb shell am broadcast -a com.android.vending.INSTALL_REFERRER -n com.wikipedia.dev/com.wikipedia.analytics.InstallReceiver --es "referrer" "referrer_url=gibberish&campaign_id=foo&install_id=bar"`
