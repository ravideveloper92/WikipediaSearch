...
import com.wikipedia.appshortcuts.AppShortcuts;
import com.wikipedia.auth.AccountUtil;
import com.wikipedia.readinglist.ReadingListSyncBehaviorDialogs;
import com.wikipedia.readinglist.sync.ReadingListSyncAdapter;
import com.wikipedia.recurring.RecurringTasksExecutor;
...
import com.wikipedia.appshortcuts.AppShortcuts;
import com.wikipedia.auth.AccountUtil;
import com.wikipedia.crash.CrashReportActivity;
import com.wikipedia.events.LoggedOutInBackgroundEvent;
import com.wikipedia.events.NetworkConnectEvent;
...
import com.wikipedia.events.SplitLargeListsEvent;
...
import static com.wikipedia.appshortcuts.AppShortcuts.APP_SHORTCUT_ID;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1
            ...
            String shortcutId = getIntent().getStringExtra(AppShortcuts.APP_SHORTCUT_ID);
