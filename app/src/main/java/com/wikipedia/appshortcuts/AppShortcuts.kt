package com.wikipedia.appshortcuts
    ...
    companion object {
        ...
        fun setShortcuts(app: Context) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
                CoroutineScope(Dispatchers.Main).launch(CoroutineExceptionHandler { _, msg -> run { com.wikipedia.util.log.L.e(msg) } }) {
        ...
        private fun searchShortcut(app: Context): ShortcutInfo {
            return ShortcutInfo.Builder(app, APP_SHORTCUT_ID_SEARCH)
                    ...
                    .setIntent(
                            Intent(ACTION_APP_SHORTCUT, Uri.EMPTY, app, com.wikipedia.main.MainActivity::class.java)
                                    .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                                    .putExtra(APP_SHORTCUT_ID, APP_SHORTCUT_ID_SEARCH)
                                    .putExtra(com.wikipedia.Constants.INTENT_APP_SHORTCUT_SEARCH, true))
                    .build()
        }
            ...
            return ShortcutInfo.Builder(app, APP_SHORTCUT_ID_RANDOM)
                    ...
                    .setIntent(
                            Intent(ACTION_APP_SHORTCUT, Uri.EMPTY, app, com.wikipedia.main.MainActivity::class.java)
                                    ...
                                    .putExtra(com.wikipedia.Constants.INTENT_APP_SHORTCUT_RANDOMIZER, true))
                    .build()
        }
            ...
            return ShortcutInfo.Builder(app, APP_SHORTCUT_ID_CONTINUE_READING)
                    ...
                    .setIntent(
                            Intent(ACTION_APP_SHORTCUT, Uri.EMPTY, app, com.wikipedia.main.MainActivity::class.java)
                                    ...
                                    .putExtra(com.wikipedia.Constants.INTENT_APP_SHORTCUT_CONTINUE_READING, true))
                    .build()
        }
    }
}
