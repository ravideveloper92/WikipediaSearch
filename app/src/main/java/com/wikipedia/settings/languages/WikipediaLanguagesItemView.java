...
import static com.wikipedia.search.SearchFragment.LANG_BUTTON_TEXT_SIZE_LARGER;
import static com.wikipedia.search.SearchFragment.LANG_BUTTON_TEXT_SIZE_SMALLER;
...
public class WikipediaLanguagesItemView extends LinearLayout {
    ...
    public void setContents(@NonNull String langCode, @Nullable String languageLocalizedName, int position) {
        ...
        ViewUtil.formatLangButton(langCodeView, langCode, SearchFragment.LANG_BUTTON_TEXT_SIZE_SMALLER, SearchFragment.LANG_BUTTON_TEXT_SIZE_LARGER);
