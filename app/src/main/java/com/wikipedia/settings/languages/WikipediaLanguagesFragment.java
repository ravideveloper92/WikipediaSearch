package com.wikipedia.settings.languages;
...
import com.wikipedia.analytics.AppLanguageSettingsFunnel;
...
import com.wikipedia.language.LanguagesListActivity;
import com.wikipedia.util.StringUtil;
...
import static com.wikipedia.language.LanguagesListActivity.LANGUAGE_SEARCHED;
import static com.wikipedia.settings.languages.WikipediaLanguagesActivity.INVOKE_SOURCE_EXTRA;
...
public class WikipediaLanguagesFragment extends Fragment implements WikipediaLanguagesItemView.Callback {
    ...
    @NonNull public static WikipediaLanguagesFragment newInstance(@NonNull String invokeSource) {
        ...
        args.putString(WikipediaLanguagesActivity.INVOKE_SOURCE_EXTRA, invokeSource);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        invokeSource = requireActivity().getIntent().getStringExtra(WikipediaLanguagesActivity.INVOKE_SOURCE_EXTRA);
        ...
        @Override public void onViewAttachedToWindow(@NonNull DefaultViewHolder holder) {
            ...
            if (holder instanceof WikipediaLanguageItemHolder) {
                ...
                holder.getView().setOnClickListener(v -> {
                    ...
                    startActivityForResult(intent, Constants.ACTIVITY_REQUEST_ADD_A_LANGUAGE);
                    finishActionMode();
                });
            }
        }
    ...
    private boolean launchedFromSearch() {
        String source = requireActivity().getIntent().hasExtra(WikipediaLanguagesActivity.INVOKE_SOURCE_EXTRA) ? requireActivity().getIntent().getStringExtra(WikipediaLanguagesActivity.INVOKE_SOURCE_EXTRA) : "";
