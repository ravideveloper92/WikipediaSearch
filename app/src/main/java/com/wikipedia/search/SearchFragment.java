...
import com.wikipedia.analytics.SearchFunnel;
...
import com.wikipedia.views.CabSearchView;
import com.wikipedia.views.LanguageScrollView;
...
import static com.wikipedia.Constants.ACTIVITY_REQUEST_ADD_A_LANGUAGE_FROM_SEARCH;
import static com.wikipedia.Constants.INTENT_EXTRA_INVOKE_SOURCE;
import static com.wikipedia.Constants.InvokeSource.INTENT_PROCESS_TEXT;
import static com.wikipedia.Constants.InvokeSource.INTENT_SHARE;
import static com.wikipedia.settings.languages.WikipediaLanguagesFragment.ACTIVITY_RESULT_LANG_POSITION_DATA;
