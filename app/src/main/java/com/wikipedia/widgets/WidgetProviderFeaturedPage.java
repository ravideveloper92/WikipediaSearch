...
import com.wikipedia.staticdata.MainPageNameData;
...
import static com.wikipedia.page.PageActivity.EXTRA_PAGETITLE;
    ...
    private String findFeaturedArticleTitle(String pageLeadContent) {
        ...
        for (URLSpan span : spans) {
            ...
            PageTitle title = WikipediaApp.getInstance().getWikiSite()
                    .titleForInternalLink(UriUtil.decodeURL(span.getURL()));
