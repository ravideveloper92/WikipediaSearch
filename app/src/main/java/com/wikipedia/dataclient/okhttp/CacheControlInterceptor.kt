...
internal class CacheControlInterceptor : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (com.wikipedia.dataclient.okhttp.OfflineCacheInterceptor.SAVE_HEADER_SAVE == chain.request().header(com.wikipedia.dataclient.okhttp.OfflineCacheInterceptor.SAVE_HEADER)) {
