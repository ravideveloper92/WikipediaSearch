...
import com.wikipedia.language.AppLanguageLookUpTable;
...
import static com.wikipedia.language.AppLanguageLookUpTable.CHINESE_LANGUAGE_CODE;
...
public final class L10nUtil {
    ...
    public static int getUpdatedLanguageCountIfNeeded(String getLanguageCode, int originalLanguageCount) {
        ...
        if (getLanguageCode.equals(AppLanguageLookUpTable.CHINESE_LANGUAGE_CODE)) {
            updatedLanguageCount = updatedLanguageCount + 2; // for both Traditional and Simplified
        } else if (getLanguageCode.equals(AppLanguageLookUpTable.TRADITIONAL_CHINESE_LANGUAGE_CODE) || getLanguageCode.equals(AppLanguageLookUpTable.SIMPLIFIED_CHINESE_LANGUAGE_CODE)) {
