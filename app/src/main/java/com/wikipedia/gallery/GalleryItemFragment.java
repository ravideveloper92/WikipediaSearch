...
import com.wikipedia.views.ZoomableDraweeViewWithBackground;
...
import static com.wikipedia.util.PermissionUtil.hasWriteExternalStoragePermission;
import static com.wikipedia.util.PermissionUtil.requestWriteStorageRuntimePermissions;
...
public class GalleryItemFragment extends Fragment {
        ...
        disposables.add(ServiceFactory.get(pageTitle.getWikiSite()).getMediaInfo(mediaListItem.getTitle())
                ...
                .subscribe(response -> {
                    ...
                    if (FileUtil.isVideo(mediaListItem.getType())) {
                        ...
                        loadImage(ImageUrlUtil.getUrlForPreferredSize(mediaInfo.getThumbUrl(), Constants.PREFERRED_GALLERY_IMAGE_SIZE));
                    }
                }, throwable -> {
    ...
    private void shareImage() {
        ...
        new ImagePipelineBitmapGetter(ImageUrlUtil.getUrlForPreferredSize(mediaInfo.getThumbUrl(), Constants.PREFERRED_GALLERY_IMAGE_SIZE)){
            @Override
