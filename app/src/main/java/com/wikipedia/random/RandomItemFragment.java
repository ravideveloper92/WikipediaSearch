...
import static com.wikipedia.Constants.PREFERRED_CARD_THUMBNAIL_SIZE;
...
public class RandomItemFragment extends Fragment {
    ...
    private void updateContents() {
        ...
        imageView.loadImage(TextUtils.isEmpty(summary.getThumbnailUrl())
                ? null : Uri.parse(ImageUrlUtil.getUrlForPreferredSize(summary.getThumbnailUrl(), Constants.PREFERRED_CARD_THUMBNAIL_SIZE)));
    }
