package com.wikipedia.edit.preview;
...
import com.wikipedia.edit.summaries.EditSummaryTag;
...
import com.wikipedia.edit.EditSectionActivity;
import com.wikipedia.edit.summaries.EditSummaryTag;
...
import com.wikipedia.page.PageTitle;
import com.wikipedia.page.PageViewModel;
import com.wikipedia.util.ConfigurationCompat;
...
import static com.wikipedia.dataclient.RestService.PAGE_HTML_PREVIEW_ENDPOINT;
        ...
        if (!isWebViewSetup) {
            ...
            bridge.addListener("link", new LinkHandler(requireActivity()) {
                ...
                public void onExternalLinkClicked(@NonNull final Uri uri) {
                    showLeavingEditDialogue(() -> UriUtil.handleExternalLink(getContext(), uri));
                }
