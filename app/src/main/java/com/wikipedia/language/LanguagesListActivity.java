...
import com.wikipedia.analytics.AppLanguageSearchingFunnel;
import com.wikipedia.dataclient.ServiceFactory;
import com.wikipedia.dataclient.mwapi.SiteMatrix;
import com.wikipedia.settings.languages.WikipediaLanguagesFragment;
...
import static com.wikipedia.settings.languages.WikipediaLanguagesFragment.ADD_LANGUAGE_INTERACTIONS;
import static com.wikipedia.settings.languages.WikipediaLanguagesFragment.SESSION_TOKEN;
...
public class LanguagesListActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        searchingFunnel = new AppLanguageSearchingFunnel(getIntent().getStringExtra(WikipediaLanguagesFragment.SESSION_TOKEN));
        requestLanguages();
    }
