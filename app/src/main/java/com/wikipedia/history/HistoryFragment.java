...
import static com.wikipedia.Constants.HISTORY_FRAGMENT_LOADER_ID;
...
public class HistoryFragment extends Fragment implements BackPressedHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LoaderManager.getInstance(requireActivity()).initLoader(Constants.HISTORY_FRAGMENT_LOADER_ID, null, loaderCallback);
        return view;
    }
    ...
    public void onDestroyView() {
        LoaderManager.getInstance(requireActivity()).destroyLoader(Constants.HISTORY_FRAGMENT_LOADER_ID);
    ...
    private void restartLoader() {
        LoaderManager.getInstance(requireActivity()).restartLoader(Constants.HISTORY_FRAGMENT_LOADER_ID, null, loaderCallback);
    }
