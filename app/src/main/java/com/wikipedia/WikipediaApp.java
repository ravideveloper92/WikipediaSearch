...
import com.wikipedia.analytics.FunnelManager;
import com.wikipedia.analytics.SessionFunnel;
import com.wikipedia.auth.AccountUtil;
import com.wikipedia.concurrency.RxBus;
import com.wikipedia.connectivity.NetworkConnectivityReceiver;
import com.wikipedia.crash.AppCenterCrashesListener;
import com.wikipedia.database.Database;
import com.wikipedia.database.DatabaseClient;
...
import com.wikipedia.dataclient.fresco.DisabledCache;
import com.wikipedia.dataclient.okhttp.CacheableOkHttpNetworkFetcher;
import com.wikipedia.dataclient.okhttp.OkHttpConnectionFactory;
import com.wikipedia.edit.summaries.EditSummary;
import com.wikipedia.events.ChangeTextSizeEvent;
import com.wikipedia.events.ThemeChangeEvent;
import com.wikipedia.history.HistoryEntry;
import com.wikipedia.language.AcceptLanguageUtil;
import com.wikipedia.language.AppLanguageState;
import com.wikipedia.notifications.NotificationPollBroadcastReceiver;
import com.wikipedia.page.tabs.Tab;
import com.wikipedia.pageimages.PageImage;
import com.wikipedia.search.RecentSearch;
import com.wikipedia.settings.Prefs;
import com.wikipedia.settings.RemoteConfig;
import com.wikipedia.settings.SiteInfoClient;
...
import static com.wikipedia.settings.Prefs.getTextSizeMultiplier;
import static com.wikipedia.util.DimenUtil.getFontSizeFromSp;
import static com.wikipedia.util.ReleaseUtil.getChannel;
